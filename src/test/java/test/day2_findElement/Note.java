...
driver.navigate().to("URL")
	...
	-> the difference between .get and navigate().to() is get method will wait the page to be loaded, but navigate().to() method will not wait.
	It will just continue to the page.
...
3- partialLinkText:
	...
	--> this locator allows us to locate LINKS by their texts, BUT it does not expect the exact text to be passed.
	Only check if the given text is contained in the link
