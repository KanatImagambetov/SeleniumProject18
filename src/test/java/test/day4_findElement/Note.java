...
-->	Locating the same webElement using this syntax:
	...
	#2 -> using href attribute value :
		...
		If your xpath is returning you more than one web elements and you want to specify which one you get,
		 you surround the xpath with (), and pass the index number in []
    #3 -> //a[@data-analytics-title='iphone']
		(//a[@data-analytics-title='iphone'])[1]
		-> If the webelements are siblings to each other, you dont have to surround with paranthesis.
		You can directly pass index number using []
